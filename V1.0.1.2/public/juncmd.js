...
$('#cmd_whole').click(function(){
    ...
    txt += '<div contenteditable="false"><span class="command-cmd">CMD：></span>&nbsp;+ 命令行工具当前版本 - V1.0.1.2</div>';
    ...
    txt += '<div contenteditable="false"><span class="command-cmd">CMD：></span>&nbsp;+ cd 文件路径[必填] -l  遍历该文件的缓存历史记录，根据遍历出来的记录可点击还原与删除</div>';
